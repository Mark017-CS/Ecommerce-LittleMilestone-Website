      ...
      {loading ? (
        ...
        <Fragment>
            ...
            <div>
              ...
              <div className="detailsBlock-3">
                ...
                <select onChange={(e) => setSize(e.target.value)}>
                      <option value="size" className="detailsBlock-3-1-1">Choose Size</option>
              ...
              <div className="detailsBlock-4">
                ...
                <br></br>
                <br></br>Description : <p>{product.description}</p>
              </div>
          ...
          {product.reviews && product.reviews[0] ? (
           ...
           <h2 className="homeHeadings">You may also like</h2>
